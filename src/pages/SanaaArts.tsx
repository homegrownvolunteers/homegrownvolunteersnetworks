...
import { ARTS_DETAILS } from "@/lib/subcategory-details";
    ...
    <Layout>
      ...
      <section className="py-20">
        <div className="container">
          <SectionHeading title="Art Disciplines" subtitle="Click any discipline to explore details and connect with the community." />
      ...
      <section className="py-20">
        <div className="container">
          ...
          <div ref={artistStagger.ref} className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className={cn("text-center group opacity-0", artistStagger.visibleItems[i - 1] && "animate-stagger-in")}>
      ...
      <SubcategoryDetailModal
        ...
        detail={selectedCat ? ARTS_DETAILS[selectedCat] || null : null}
      />
    </Layout>
  );
}
