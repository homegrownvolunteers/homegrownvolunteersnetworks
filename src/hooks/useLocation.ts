...
export const HARDCODED_WARDS: Ward[] = [
  // Imenti North (1)
  { id: 1, name: 'Mwanganthia', sub_county_id: 1 },
  { id: 2, name: 'Naari', sub_county_id: 1 },
  { id: 3, name: 'Ruiri', sub_county_id: 1 },
  { id: 4, name: 'Timau', sub_county_id: 1 },
  { id: 5, name: 'Kibirichia', sub_county_id: 1 },
  { id: 6, name: 'Katheri', sub_county_id: 1 },
  { id: 7, name: 'Mukure', sub_county_id: 1 },
  // Imenti South (2)
  { id: 8, name: 'Abogeta East', sub_county_id: 2 },
  { id: 9, name: 'Abogeta West', sub_county_id: 2 },
  { id: 10, name: 'Igoji East', sub_county_id: 2 },
  { id: 11, name: 'Igoji West', sub_county_id: 2 },
  { id: 12, name: 'Nkuene', sub_county_id: 2 },
  { id: 13, name: 'Kibiriria', sub_county_id: 2 },
  { id: 14, name: 'Mitunguu', sub_county_id: 2 },
  { id: 15, name: 'Ruiri', sub_county_id: 2 },
  { id: 16, name: 'Kangeta', sub_county_id: 2 },
  { id: 17, name: 'Mitunguu II', sub_county_id: 2 },
  // Imenti Central (3)
  { id: 18, name: 'Mariani', sub_county_id: 3 },
  { id: 19, name: 'Mikindji', sub_county_id: 3 },
  { id: 20, name: 'Mitunguu', sub_county_id: 3 },
  { id: 21, name: 'Mitunguu II', sub_county_id: 3 },
  { id: 22, name: 'Nkuru', sub_county_id: 3 },
  { id: 23, name: 'Rwarera', sub_county_id: 3 },
  { id: 24, name: 'Kianjai', sub_county_id: 3 },
  { id: 25, name: 'Kibugua', sub_county_id: 3 },
  { id: 26, name: 'Muthara', sub_county_id: 3 },
  // Tigania East (4)
  { id: 27, name: 'Kianjeru', sub_county_id: 4 },
  { id: 28, name: 'Muthara', sub_county_id: 4 },
  { id: 29, name: 'Nkubu', sub_county_id: 4 },
  { id: 30, name: 'Thithini', sub_county_id: 4 },
  // Tigania West (5)
  { id: 31, name: 'Kipini', sub_county_id: 5 },
  { id: 32, name: 'Mitunguu', sub_county_id: 5 },
  { id: 33, name: 'Mutuati', sub_county_id: 5 },
  { id: 34, name: 'Nkubu', sub_county_id: 5 },
  // Igembe North (6)
  { id: 35, name: 'Kangeta', sub_county_id: 6 },
  { id: 36, name: 'Kianjai', sub_county_id: 6 },
  { id: 37, name: 'Mitunguu', sub_county_id: 6 },
  { id: 38, name: 'Mutuati', sub_county_id: 6 },
  // Igembe Central (7)
  { id: 39, name: 'Akachiu', sub_county_id: 7 },
  { id: 40, name: 'Kanuni', sub_county_id: 7 },
  { id: 41, name: 'Kibiyo', sub_county_id: 7 },
  { id: 42, name: 'Mitunguu', sub_county_id: 7 },
  { id: 43, name: 'Nthambiro', sub_county_id: 7 },
  // Igembe South (8)
  { id: 44, name: 'Athiru', sub_county_id: 8 },
  { id: 45, name: 'Gakiranine', sub_county_id: 8 },
  { id: 46, name: 'Mitunguu', sub_county_id: 8 },
  { id: 47, name: 'Njiiri', sub_county_id: 8 },
  // Buuri (9)
  { id: 48, name: 'Kibuon', sub_county_id: 9 },
  { id: 49, name: 'Kibutha', sub_county_id: 9 },
  { id: 50, name: 'Mitunguu', sub_county_id: 9 },
  { id: 51, name: 'Ruiri', sub_county_id: 9 },
